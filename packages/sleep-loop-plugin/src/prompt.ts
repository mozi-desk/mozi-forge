...
Use the existing Trainer workflow: analyze evidence, save a Training Plan with sourceSessions, obtain plan review, write proposals, obtain each session-based proposal review, then run the existing training iterations. An empty window or no actionable finding needs a conclusion, not an invented proposal.\n
