...
- Store plans and Markdown proposals; prepare one HEAD worktree per plan. Require approved plan scope and verified tree identity for integration and preserve destination changes.
